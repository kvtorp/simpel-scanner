sap.ui.core.mvc.Controller.extend("nszscanner.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "nszscanner.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "nszscanner.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("BarcodeNumber", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
